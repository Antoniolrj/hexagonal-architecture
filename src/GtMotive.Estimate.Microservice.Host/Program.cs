...
builder.Configuration.SetFileProvider(new NullFileProvider());

// Configuration.
if (!builder.Environment.IsDevelopment())
{
    builder.Configuration.AddJsonFile("serilogsettings.json", optional: false, reloadOnChange: false);
...
builder.Services.AddBaseInfrastructure(builder.Configuration, builder.Environment.IsDevelopment());
